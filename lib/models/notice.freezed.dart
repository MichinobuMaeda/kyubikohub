...
class _$NoticeImpl implements _Notice {
  ...
  @override
  String toString() {
    return 'Notice(id: $id, title: $title, message: $message, note: $note, createdAt: $createdAt, updatedAt: $updatedAt, deletedAt: $deletedAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, title, message, note, createdAt, updatedAt, deletedAt);
...
abstract class _Notice implements Notice {
  const factory _Notice(
      ...
      required final DateTime? deletedAt}) = _$NoticeImpl;
