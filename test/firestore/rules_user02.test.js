...
describe('After Sing-in as User 02', () => {
  ...
  it('0080', () => allowedToAddDoc("logs", "0003")(true));
  it('0081', () => allowedToReadDoc("logs", "0003")(false));
  it('0082', () => allowedToUpdateDoc("logs", "0003")(false));
  it('0083', () => allowedToDeleteDoc("logs", "0003")(false));
  it('0085', () => allowedToAddDoc("sites", "test", "logs", "0003")(true));
  it('0086', () => allowedToReadDoc("sites", "test", "logs", "0003")(false));
  it('0087', () => allowedToUpdateDoc("sites", "test", "logs", "0003")(false));
  it('0088', () => allowedToDeleteDoc("sites", "test", "logs", "0003")(false));
});
